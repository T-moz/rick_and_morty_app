...
class CharacterAdapter extends TypeAdapter<_$_Character> {
  @override
  final int typeId = 0;

  @override
  _$_Character read(BinaryReader reader) {
    ...
    return _$_Character(
      ...
      origin: fields[6] as CharacterLocation,
  ...
  @override
  void write(BinaryWriter writer, _$_Character obj) {
    writer
      ..writeByte(12)
      ..writeByte(0)
      ..write(obj.id)
