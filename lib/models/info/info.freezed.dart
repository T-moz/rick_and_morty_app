...
/// @nodoc
@JsonSerializable()
@HiveType(typeId: 3, adapterName: 'InfoAdapter')
class _$_Info implements _Info {
  const _$_Info(
      {@HiveField(0) required this.count,
      @HiveField(2) required this.pages,
      @HiveField(3) this.next,
      @HiveField(4) this.prev});
...
abstract class _Info implements Info {
  const factory _Info(
      ...
      @HiveField(2) required int pages,
      @HiveField(3) String? next,
      @HiveField(4) String? prev}) = _$_Info;
